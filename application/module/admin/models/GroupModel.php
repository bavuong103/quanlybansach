    ...
    private $_columns = array('id', 'name', 'group_acp', 'created', 'created_by', 'modified', 'modified_by', 'status', 'ordering');
        ...
        public function countItem($arrParam, $option = null)
        {
            ...
            if(isset($arrParam['filter_state']) && $arrParam['filter_state']!='default')
            {
             ...
             //FILTER: GroupACP
            // Khi chon 1 GroupACP tu selectBox
        ...
        public function changeStatus($arrParam, $option = null)
        {
            ...
            if($option['task'] == 'change-ajax-status')
            {
                ...
                $result = array($id, $status, URL::createLink('admin','group','ajaxStatus', array('id'=>$id, 'status'=>$status)));
            ...
            if($option['task'] == 'change-ajax-group-acp')
            {
                ...
                $result = array($id, $group_acp, URL::createLink('admin','group','ajaxGroupACP', array('id'=>$id, 'group_acp'=>$group_acp)));
                
                //Session::set('message', array('class' => 'success','content'=>'Phần tử được thay đổi Group acp! '));
